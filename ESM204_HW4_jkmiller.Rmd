...
# Integrate under the marginal abatement curve to the supply of carbon at the tax price
lossA_trade_diff = integrate(curve_a, 80, supplyA(taxprice))
lossA_trade_diff$value # 128.2757

lossB_trade_diff = integrate(curve_b, 100, supplyB(taxprice))
lossB_trade_diff$value # 1766.78

lossC_trade_diff = integrate(curve_c, 120, supplyC(taxprice))
lossC_trade_diff$value # -3340


# take the differences
diff_a = lossA_trade$value - lossA_trade_diff$value
diff_a
diff_b = lossB_trade$value - lossB_trade_diff$value
diff_b
diff_c = lossC_trade$value - lossC_trade_diff$value
diff_c



cost_country = diff_a + diff_b + diff_c
cost_country
